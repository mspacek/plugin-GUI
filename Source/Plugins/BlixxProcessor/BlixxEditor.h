...
#ifndef BLIXXEDITOR_H_INCLUDED
#define BLIXXEDITOR_H_INCLUDED
...
class BlixxEditor : public GenericEditor    //Generic Editor adds listeners for buttons and sliders. 
...
public:
    ...
    BlixxEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(BlixxEditor);
};
